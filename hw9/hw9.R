...
mtcars = data.frame(mtcars, model)
...
bub <- gvisBubbleChart(mtcars.new, idvar= "model", xvar= "disp", yvar= "mpg", 
...
Motion <- gvisMotionChart(WorldDat, idvar= "country", xvar= "fertility.rate", 
                          yvar= "life.expectancy", timevar= "year", colorvar= "region", 
                          sizevar= "population")
